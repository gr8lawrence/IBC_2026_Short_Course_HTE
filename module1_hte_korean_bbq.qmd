...
::: {.fragment}
Combining both groups — bold entries are values observed in reality:
...
::: {#fig-potential-outcomes layout-ncol=1 fig-align="center"}
![](images/choose_pos.jpg){width="35%"}

When facing the fundamental problem of causal inference...
:::
...
::: {.fragment}
::: callout-note
The ATE is a direct, identifiable causal quantity (estimand). 
:::
:::

## Average Treatment Effect: ATE (Cont.)

::: {#fig-ite-vs-ate layout-ncol=1 fig-align="center"}
![](images/ITE_vs_ATE.jpg){width="50%"}
...
::: {#fig-hte-question layout-ncol=1 fig-align="center"}
![](images/HTE_question.jpg){width="54%"}
...
*The CATE at* $X_i = x$ *is the expected difference in outcome if everyone with characteristics* $x$ *received the treatment versus if everyone with those characteristics did not.*
:::
...
::: {.fragment}
To plan and conduct the analysis effectively, you want to understand the research questions and their associated tasks.
:::

## HTE Questions and Tasks (Cont.)


::: {#fig-hte-questions layout-ncol=1 fig-align="center"}
![](images/just-do-everything.jpg){width="50%"}

Everyone's favortie collaborator
:::
...
::: {#fig-causal-assumptions layout-ncol=1 fig-align="center"}
![](images/causal-assumptions.jpg){width="44%"}

All assumptions are checked! Or are they?
:::
...
## CATE Estimation Methods (Cont.)

::: {#fig-cate-estimation layout-ncol=1 fig-align="center"}
![](images/Meta-Learners-Causal-ML.jpg){width="54%"}

United by one (estimation) goal
:::
...
::: {#fig-change-my-mind layout-ncol=1 fig-align="center"}
![](images/regression-s-learner.jpg){width="54%"}
...
- **Noisy subgroup discovery** — overfitting.
...
::: {#fig-take-home layout-ncol=1 fig-align="center"}
![](images/finishing-short-course.jpg){width="36%"}
